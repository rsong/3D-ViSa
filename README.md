...
[3D saliency maps for 3D meshes](https://drive.google.com/file/d/1SphvQhkxwM7ok6vNVeH--ii7z_gP6XdI/view?usp=sharing) - 540 view-dependent 3D saliency maps for the 3D meshes. Each 3D saliency map is generated by mapping the corresponding 2D saliency map onto the surface of the 3D mesh while considering the visibility of each 3D point with regard to the corresponding viewpoint. Here we provide the MATLAB code 'create_3dsaliency.m' for doing so.
